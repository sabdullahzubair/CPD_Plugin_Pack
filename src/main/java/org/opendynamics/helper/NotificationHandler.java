...
public class NotificationHandler {
    ...
    public void sendVerificationCode(String id, String email, String verificationCode){
        ...
        String content = "<p>Dear User,</p>" +
                "<p>In order to activate your account Please click <a href=\"http://membership.mma.org.my/jw/web/json/plugin/org.opendynamics.AccountVerification/service?at=cpdp&acId="
                + id +"&vc="+ verificationCode +"\">here</a></p>";
